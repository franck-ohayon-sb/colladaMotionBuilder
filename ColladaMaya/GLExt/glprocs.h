...
#ifdef __PPU__
	#include <PSGL/psgl.h>
	#include <PSGL/glext.h>
#elif MAC_TIGER
	// Don't include on Tiger. CarbonOpenGL includes this
...
typedef struct {
  ...
  const GLbyte* (WINAPI *GetExtensionsStringARB) (HDC hdc);
  ...
  const GLbyte* (WINAPI *GetExtensionsStringEXT) (void);
